...
// beta is effect of GDD on arrival for each species/cell
...
// kappa is effect of GDD on arrival at mean species PC1
...
int<lower=0> M;                      // number species/cells
int<lower=0> O;                      // number species
vector[N] y;                  // arrival date
vector[N] gdd;                  // GDD
array[N] int<lower=0> SpSt;
array[M] int<lower=0> Sp;                // species id for each species/cell
vector[M] lat;                     // lat for each species/cell
